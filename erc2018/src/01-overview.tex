...
The inclination of SMT solvers to integrate concepts of induction~\cite{VMCAI2015:Reynolds} and higher-order reasoning~\cite{Misc2020:Tourret} on one hand,
...
The Matryoshka project (\cite{Misc2020:Tourret,CADE2020:Vukmirovic} and more) set as their target to enrich SMT solvers with higher-order constructs such as recursive definitions and second-order quantification.
