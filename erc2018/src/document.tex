...
Surely it has happened to everyone: you have a conjecture to prove, and there is
a theorem that whose fits the conjecture, but the premises don't quite match
with the assumptions in that particular context.
As a simple example, suppose the conjecture is $n^*(x,z)$, where $n^*$ is the
