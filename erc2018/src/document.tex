...
much more powerful software construction and certification mechanisms. \todo{``certification'' appears first here}
...
\paragraph{Autmoated Theorem Provers (ATP)} A family of tools and techniques based on proof
...
solving Constrained Horn Clauses using IC3 (and its subsequent variants) while utilizing an underlying SMT solver,
and cyclic proof search with implicit induction for ATP.
\todo{expand, introduce TC and the cyclic proof system for it}
