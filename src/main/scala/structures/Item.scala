...
object Repetition {
  ...
  def rep0[Value, Id](maxRepetition: Int, repeated: Stream[Item[Value, Id]]): Option[Repetition[Value, Id]] = rep(0, maxRepetition, repeated)
  def rep1[Value, Id](maxRepetition: Int, repeated: Stream[Item[Value, Id]]): Option[Repetition[Value, Id]] = rep(1, maxRepetition, repeated)
  def rep[Value, Id](minRepetition: Int, maxRepetition: Int, repeated: Stream[Item[Value, Id]]): Option[Repetition[Value, Id]] = {
