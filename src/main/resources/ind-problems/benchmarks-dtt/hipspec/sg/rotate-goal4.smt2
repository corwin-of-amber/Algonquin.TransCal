...
(assert 
(forall ((n Int) (m Int) (x Lst)) (=> (and (>= n 0) (>= m 0)) (= (rotate n (rotate m x)) (rotate m (rotate n x)))))  ; G3 
)

; conjecture
(assert (not 
(forall ((n Int) (m Int) (x Lst)) (=> (and (>= n 0) (>= m 0)) (= (rotate (+ 1 n) (rotate m x)) (rotate (+ 1 m) (rotate n x)))))  ; G4 
))
(check-sat)
