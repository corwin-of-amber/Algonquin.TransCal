...
; proven
(assert 
(forall ((n Int) (m Int)) (=> (and (>= n 0) (>= m 0)) (= (plus n m) (plus m n))))  ; G-nichomachus-1 
)

; conjecture
(assert (not 
(forall ((x Int) (y Int) (z Int)) (=> (and (>= x 0) (>= y 0) (>= z 0)) (= (plus x (plus y z)) (plus (plus y x) z))))  ; G-nichomachus-2 
))
(check-sat)
