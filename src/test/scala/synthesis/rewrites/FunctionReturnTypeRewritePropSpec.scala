...
class FunctionReturnTypeRewritePropSpec extends PropSpec with Checkers {
  property("Finds in the graph") {
    val graph = VersionedHyperGraph(
      ...
      HyperEdge(HyperTermId(1), HyperTermIdentifier(Identifier("f")), Seq.empty, EmptyMetadata),
      ...
      HyperEdge(HyperTermId(7), HyperTermIdentifier(Identifier("f")), Seq(HyperTermId(8), HyperTermId(9), HyperTermId(10)), EmptyMetadata)
    )
  ...
  property("Finds 2 different usages of the same function in the graph") {
    val graph = VersionedHyperGraph(
      ...
      HyperEdge(HyperTermId(27), HyperTermIdentifier(Identifier("f")), Seq(HyperTermId(28), HyperTermId(29), HyperTermId(210)), EmptyMetadata)
    )
    val expectedNewEdges = Set(
      HyperEdge(HyperTermId(0), HyperTermIdentifier(Language.typeId), Seq(HyperTermId(7), HyperTermId(6)), EmptyMetadata),
  ...
  property("Finds 2 different functions in the graph") {
    val graph = VersionedHyperGraph(
      ...
      HyperEdge(HyperTermId(21), HyperTermIdentifier(Identifier("g")), Seq.empty, EmptyMetadata),
      ...
      HyperEdge(HyperTermId(27), HyperTermIdentifier(Identifier("g")), Seq(HyperTermId(8), HyperTermId(9), HyperTermId(10)), EmptyMetadata)
    )
    val expectedNewEdges = Set(
      HyperEdge(HyperTermId(0), HyperTermIdentifier(Language.typeId), Seq(HyperTermId(7), HyperTermId(6)), EmptyMetadata),
